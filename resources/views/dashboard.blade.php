    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex gap-2 mb-6">
                ...
                <!-- Box 2 -->
                <div class="flex-1 bg-gradient-to-r from-blue-400 to-green-500 shadow-md rounded-lg p-6 text-center text-white">
                    ...
                    <div class="filter flex justify-center gap-2 mt-2">
                        <form>
                            ...
                            <select name="month" id="month" class="rounded text-gray-700">
                                ...
                                <option value="1" @if(request()->query('month') === "1") selected @endif>Januari</option>
                                <option value="2" @if(request()->query('month') === "2") selected @endif>Februari</option>
                                ...
                                <option value="8" @if(request()->query('month') === "8") selected @endif>Agustus</option>
                                <option value="9" @if(request()->query('month') === "9") selected @endif>September</option>
                                <option value="10" @if(request()->query('month') === "10") selected @endif>Oktober</option>
                                <option value="11" @if(request()->query('month') === "11") selected @endif>November</option>
                                <option value="12" @if(request()->query('month') === "12") selected @endif>Desember</option>
                            </select>
