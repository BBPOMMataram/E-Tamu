...
<div class="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center z-[9999]" id="popup-overlay">
    ...
    <!-- Popup Modal -->
    <div class=" p-6 rounded-lg shadow-lg w-80 relative">
        <!-- Close Button -->
        <div class="absolute top-2 right-2 cursor-pointer text-gray-500 hover:text-gray-700" onclick="togglePopup()">Tutup
            ✕</div>
